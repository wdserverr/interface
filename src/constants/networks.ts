...
export const RPC_URLS: { [key in SupportedChainId]: string[] } = {
  [SupportedChainId.MAINNET]: [`https://rpc.ankr.com/eth`, ...FALLBACK_URLS[SupportedChainId.MAINNET]],
  // [SupportedChainId.RINKEBY]: [
  ...
  [SupportedChainId.OPTIMISM]: [`https://rpc.ankr.com/optimism`, ...FALLBACK_URLS[SupportedChainId.OPTIMISM]],
  // [SupportedChainId.OPTIMISM_GOERLI]: [
  //   `https://optimism-goerli.infura.io/v3/${INFURA_KEY}`,
  //   ...FALLBACK_URLS[SupportedChainId.OPTIMISM_GOERLI],
  // ],
  [SupportedChainId.ARBITRUM_ONE]: [`https://rpc.ankr.com/arbitrum`, ...FALLBACK_URLS[SupportedChainId.ARBITRUM_ONE]],
  // [SupportedChainId.ARBITRUM_RINKEBY]: [
  //   `https://arbitrum-rinkeby.infura.io/v3/${INFURA_KEY}`,
  //   ...FALLBACK_URLS[SupportedChainId.ARBITRUM_RINKEBY],
  // ],
  [SupportedChainId.POLYGON]: [`https://rpc.ankr.com/polygon`, ...FALLBACK_URLS[SupportedChainId.POLYGON]],
  // [SupportedChainId.POLYGON_MUMBAI]: [
